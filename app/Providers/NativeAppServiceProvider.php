...
class NativeAppServiceProvider implements ProvidesPhpIni
{
    ...
    public function boot(): void
    {
        ...
        try {
            // Boot runs in the long-lived php -S server process. The helper
            // watches this pid and exits with it; a start from the download
            // job reuses it instead of the short-lived worker's own pid.
            AppSettings::setSidecarParentPid(getmypid());
