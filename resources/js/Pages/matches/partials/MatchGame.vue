    ...
    <Card class="overflow-hidden">
        ...
        <CardHeader class="bg-muted flex flex-row flex-wrap items-center gap-3 px-4 py-3">
            <div class="flex items-center gap-2">
                ...
                <Badge v-if="game.result === 'W'" class="border-transparent bg-win text-win-foreground">Win</Badge>
            ...
            <div class="flex min-w-0 flex-1 flex-col gap-4">
                ...
                <div>
                    ...
                    <div v-if="game.sideboardChanges.length" class="space-y-1">
                        ...
                        >
                            <span class="w-6 font-mono font-semibold" :class="change.type === 'in' ? 'text-win' : 'text-destructive'">
