...
beforeEach(function () {
    ...
    // Simulate an already-registered device so RegisterDevice::ensureFresh()
    // (invoked by the mymtgoReference macro) doesn't fire an extra
    // registration request ahead of the lookups these tests assert on.
