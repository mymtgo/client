...
> **Compatibility:** TypeScript 5.9+, Node.js 22 LTS, Vite 7, NestJS 11, Vue 3.5
...
Use when:
- Building type-safe Vue, NestJS, or Node.js applications
...
// Typed props via defineProps with TypeScript
...
<template>
  <button :class="props.variant" @click="emit('click', $event)">
    {{ props.label }}
  </button>
</template>
```
...
See [vue-integration.md](references/vue-integration.md) and [nestjs-integration.md](references/nestjs-integration.md) for detailed patterns.
...
- [vue-integration.md](references/vue-integration.md) — Vue 3 + TypeScript patterns
- [inertia-integration.md](references/inertia-integration.md) — Inertia.js v3 + Laravel Data patterns
