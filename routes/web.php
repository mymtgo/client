...
use App\Http\Controllers\Decks\SideboardGuides\DestroyController as SideboardGuideDestroyController;
use App\Http\Controllers\Decks\SideboardGuides\EditController as SideboardGuideEditController;
use App\Http\Controllers\Decks\SideboardGuides\StoreController as SideboardGuideStoreController;
...
Route::group([], function (Router $router) {
    ...
    $router->group([
        ...
        $group->get('{deck:id}/sideboard-guides', SideboardGuidesController::class)->name('decks.sideboard-guides.index')->withTrashed();
        $group->post('{deck:id}/sideboard-guides', SideboardGuideStoreController::class)->name('decks.sideboard-guides.store')->withTrashed();
        $group->get('{deck:id}/sideboard-guides/{sideboardGuide}', SideboardGuideEditController::class)->name('decks.sideboard-guides.edit')->withTrashed()->scopeBindings();
        $group->put('{deck:id}/sideboard-guides/{sideboardGuide}', SideboardGuideUpdateCardsController::class)->name('decks.sideboard-guides.update')->withTrashed()->scopeBindings();
        $group->delete('{deck:id}/sideboard-guides/{sideboardGuide}', SideboardGuideDestroyController::class)->name('decks.sideboard-guides.destroy')->withTrashed()->scopeBindings();
        $group->post('{deck:id}/sideboard-guides/{sideboardGuide}/notes', SideboardGuideStoreNoteController::class)->name('decks.sideboard-guides.notes.store')->withTrashed()->scopeBindings();
